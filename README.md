...
Manually renamed panes contribute their manual name; panes titled by another source contribute that title; filtered panes (`allow`/`deny`) contribute nothing. Spaces never call the LLM.
